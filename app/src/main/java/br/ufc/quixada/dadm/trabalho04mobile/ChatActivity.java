...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btbChat = findViewById(R.id.btnChat);
        btbChat.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private class MessageItem extends Item<ViewHolder> {
        ...
        public void bind(@NonNull ViewHolder viewHolder, int position) {
            TextView txt = viewHolder.itemView.findViewById(R.id.txtMessage);
            ImageView img = viewHolder.itemView.findViewById(R.id.imageMessageUser);
